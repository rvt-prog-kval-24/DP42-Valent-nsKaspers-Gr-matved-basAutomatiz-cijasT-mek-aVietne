                    ...
                    <div class="card">
                        <div class="card-header text-uppercase">
                            <div class="row">
                                <div class="col-lg-6 d-flex align-items-center">
                                    <strong>{{ __('Update Invoice') }}</strong>
                                </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <select id="company_id" class="form-control form-select @error('company_id') is-invalid @enderror" name="company_id">
                                        @foreach($companies as $company)
                                            <option {{ old('company_id', $company->company_id) == $company->id ? 'selected' : '' }} value="{{ $company->id }}">{{ $company->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('company_id')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6">
                                    <input id="tax_rate" type="text" class="form-control @error('tax_rate') is-invalid @enderror" name="tax_rate" value="{{ old('tax_rate', $invoice->tax_rate) }}" autocomplete="off">
                                    @error('tax_rate')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            <select id="client_type" class="form-control form-select @error('client_type') is-invalid @enderror" name="client_type">
                                                @foreach($clientTypes as $clientTypeCode => $clientTypeTitle)
                                                    <option {{ old('client_type', $invoice->client_type) == $clientTypeCode ? 'selected' : '' }} value="{{ $clientTypeCode }}">{{ $clientTypeTitle }}</option>
                                                @endforeach
                                            </select>
                                            @error('client_type')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            <input id="client_name" type="text" class="form-control @error('tax_rate') is-invalid @enderror" name="client_name" value="{{ old('client_name', $invoice->client_name) }}" autocomplete="off">
                                            @error('client_name')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            <input id="client_email" type="text" class="form-control @error('client_email') is-invalid @enderror" name="client_email" value="{{ old('client_email', $invoice->client_email) }}" autocomplete="off">
                                            @error('client_email')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            <input id="client_phone" type="text" class="form-control @error('client_phone') is-invalid @enderror" name="client_phone" value="{{ old('client_phone', $invoice->client_phone) }}" autocomplete="off">
                                            @error('client_phone')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div id="legal-entity-container" @if (old('client_type', $invoice->client_type) != 2) class="d-none" @endif>
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <hr>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="client_company" type="text" class="form-control @error('client_company') is-invalid @enderror" name="client_company" value="{{ old('client_company', $invoice->client_company) }}" autocomplete="off">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="client_vat_number" type="text" class="form-control @error('client_vat_number') is-invalid @enderror" name="client_vat_number" value="{{ old('client_vat_number', $invoice->client_vat_number) }}" autocomplete="off">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="client_reg_number" type="text" class="form-control @error('client_reg_number') is-invalid @enderror" name="client_reg_number" value="{{ old('client_reg_number', $invoice->client_reg_number) }}" autocomplete="off">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="client_iban" type="text" class="form-control @error('client_iban') is-invalid @enderror" name="client_iban" value="{{ old('client_iban', $invoice->client_iban) }}" autocomplete="off">
                                                @error('client_iban')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="client_swift" type="text" class="form-control @error('client_swift') is-invalid @enderror" name="client_swift" value="{{ old('client_swift', $invoice->client_swift) }}" autocomplete="off">
                                                @error('client_swift')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
